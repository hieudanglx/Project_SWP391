    ...
    <body>
        <div class="wrapper">
            ...
            <div class="right-section">
                <div class="login-box">
                    <h3 class="fw-bold">Xin chào lần nữa!</h3>
                    <p class="fs-5">Chào mừng trở lại</p>
                    <form action="LoginStaff_Admin" method="POST">
                        ...
                        <button type="button" class="btn btn-secondary" onclick="window.location.href = 'forgotPasswordStaff.jsp'" >Quên mật khẩu</button>
                    </form>
                </div>
            </div
        </div>
